...
export const GROCERY_PRODUCTS: Product[] = [
  ...
  { id: '20143381001', name: 'Roma Tomatoes', description: 'Fresh Roma tomatoes, sold by weight', image: 'https://assets.shop.loblaws.ca/products/20143381001/b2/en/front/20143381001_front_a06_@2.png' },
  ...
  { id: 'milk-2', name: 'Milk 2%', description: 'Partly skimmed milk, 4L jug', brand: 'No Name' },
  { id: 'eggs', name: 'Large White Eggs', description: 'Large white eggs, 12 count', brand: 'No Name' },
  { id: 'bread', name: 'White Bread', description: 'White sandwich bread, 675g loaf', brand: 'No Name' },
  { id: 'butter', name: 'Butter', description: 'Salted butter, 454g', brand: 'No Name' },
  { id: 'cheese', name: 'Cheddar Cheese', description: 'Medium cheddar cheese, 400g block', brand: 'No Name' },
